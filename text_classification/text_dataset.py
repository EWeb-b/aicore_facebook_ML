...
import utilities.clean_tabular_data as cl
...
class TextDataset(Dataset):
    ...
    Attributes:
        ...
        max_length: int, the maximum length of the text going into the
            BERT tokenizer.
    """
    def __init__(self, filepath: str = 'data/Products.csv', labels_level: int = 0,
            max_length: int = 50) -> None:
        super().__init__()
        products = cl.clean_tab_data(filepath, labels_level)
    ...
    def __getitem__(self, index):
        ...
        sentence = example['product_description']
...
if __name__ == "__main__":
    ...
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=12, shuffle=False, num_workers=1)
