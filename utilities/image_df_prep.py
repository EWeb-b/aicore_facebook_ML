...
df = result.copy()
df.drop(['id_x', 'product_name', 'price', 'location', 'product_id', 'Unnamed: 0_x', 'Unnamed: 0_y'], axis=1, inplace=True)
...
df.to_pickle('data/merged_data.zip', compression='zip', protocol=4)
