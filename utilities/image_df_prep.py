...
pdf = pd.read_csv("/home/edwardwebb/Documents/aicore/aicore_facebook_ML/data/Products.csv", lineterminator="\n")
idf = pd.read_csv("/home/edwardwebb/Documents/aicore/aicore_facebook_ML/data/Images.csv")
...
df = result.copy()
df.drop(['id_x', 'price', 'location', 'product_id', 'Unnamed: 0_x', 'Unnamed: 0_y'], axis=1, inplace=True)
...
df['id_y'] = df['id_y'].apply(lambda z: np.array(Image.open('/home/edwardwebb/Documents/aicore/aicore_facebook_ML/data/cleaned_images/' + z + '.jpg')))

# Rename the column containing the image arrays for ease of use.
df = df.rename({'id_y': 'img'}, axis = 1)
